                    ...
                    <div className='flex-auto p-6 space-y-4 md:space-y-6'>
                        ...
                        <div className="formSocial">
                            <form className="formLogin">
                                <div className='mb-2'>
                                    <label className="block text-sm md:text-lg font-medium text-gray-900">Họ tên</label>
                                    <input
                                ...
                                <div className='mb-2'>
                                    <label className="block text-sm md:text-lg font-medium text-gray-900">Email</label>
                                    <input
                                        className='my-2 text-sm md:text-base h-8 md:h-10 rounded-3xl  px-3 truncate border-solid border w-full bg-gray-50'
                                        type='email'
                                ...
                                <div className='mb-2'>
                                    <label className="block text-sm font-medium md:text-lg  text-gray-900">Mật khẩu</label>
                                    <input
                                        className='my-2 text-sm md:text-base h-8 md:h-10 rounded-3xl px-3 truncate border-solid border w-full bg-gray-50'
                                        value={password}
                                ...
                                <div className='text-center my-4'>
                                    <button type="button" onClick={submitForm} className='w-full bg-indigo-900 text-white text-sm md:text-lg font-medium px-3 py-2 rounded-3xl text-lg hover:opacity-90'>Đăng kí</button>
                                </div>
