                        ...
                        <div className="formSocial">
                            <form className="formLogin">
                                <div className='mb-2'>
                                    ...
                                    <input
                                        className='my-2 text-sm md:text-lg h-8 md:h-10 rounded-3xl px-3 truncate border-solid border w-full bg-gray-50'
                                        name="email"
                                        type='email'
                                ...
                                <div className='mb-2'>
                                    <label className="block text-lg font-medium text-gray-900">Mật khẩu</label>
                                    <input
                                        className='my-2 text-sm md:text-lg h-8 md:h-10 rounded-3xl px-3 truncate border-solid border w-full bg-gray-50'
                                        name='password'
                                        type="password"
                                ...
                                <div className='text-center my-4'>
                                    <button type="submit" onClick={handleSubmit} className='w-full bg-indigo-900 text-white text-sm font-medium px-3 py-2 rounded-3xl text-xl hover:opacity-90'>Đăng nhập</button>
                                </div>
